        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="Jashva Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Jashva Hotel</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Jashva Hotel</span></h2>
